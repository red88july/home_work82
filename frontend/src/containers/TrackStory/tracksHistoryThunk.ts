...
export const historyPostTrack = createAsyncThunk<TrackHistory, { track: string, token: string}, { rejectValue: GlobalError }>(
...
export const historyGetTrack = createAsyncThunk<TrackDataHistory [], { token: string}, { rejectValue: GlobalError }>(
